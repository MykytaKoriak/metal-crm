...
ADMIN_PERMISSIONS = (
    ...
    | _permission_set("core", "changeauditlog", FULL_ACCESS_ACTIONS)
    | _permission_set("core", "telegramupdatelog", FULL_ACCESS_ACTIONS)
    | _permission_set("core", "telegramnotification", FULL_ACCESS_ACTIONS)
    ...
    | _permission_set("crm", "warehouse", FULL_ACCESS_ACTIONS)
    | _permission_set("crm", "inventorybalance", READ_ONLY_ACTIONS)
    | _permission_set("crm", "inventoryreceipt", FULL_ACCESS_ACTIONS)
    | _permission_set("crm", "inventoryreceiptitem", FULL_ACCESS_ACTIONS)
    | _permission_set("crm", "inventorytransaction", FULL_ACCESS_ACTIONS)
    | _permission_set("crm", "productbom", FULL_ACCESS_ACTIONS)
...
SALES_MANAGER_PERMISSIONS = (
    ...
    | _permission_set("crm", "warehouse", READ_ONLY_ACTIONS)
    | _permission_set("crm", "inventorybalance", READ_ONLY_ACTIONS)
    | _permission_set("crm", "inventoryreceipt", READ_ONLY_ACTIONS)
    | _permission_set("crm", "inventoryreceiptitem", READ_ONLY_ACTIONS)
    | _permission_set("crm", "inventorytransaction", READ_ONLY_ACTIONS)
    | _permission_set("crm", "productbom", READ_ONLY_ACTIONS)
